        ...
        <div class="row g-0">
          <div class="col-lg-8">
            <div class="p-5">
              ...
              <a href="<?php echo APRURL; ?>" class="btn btn-success text-white"><i class="fas fa-arrow-left"></i>  Continue Shopping</a>
            </div>
          </div>
...
<script>
    $(document).ready(function(){
        $(".pro_amount").on('mouseup change', function(){
            ...
            $(".btn-update").on('click', function(e){  // fixed typo here
              var id = $(this).val();
        ...
        function fetch(){
          setInterval(function() {
            ...
            $('.total_price').each(function(){
              sum += parseFloat($(this).text()) || 0;  // safely parse number
            });
            $(".full_price").html(sum + "$");
          }, 4000);
        }
